...
connection = sqlite3.connect("firma.db") # Erzeugen der Datei
...
sql = "CREATE TABLE personen(" \
      ...
      "gehalt REAL, " \
      "geburtstag TEXT)"
cursor.execute(sql) # Änderungen an der Struktur werden automatisch "commited"

# Datensatz erzeugen
sql = "INSERT INTO personen VALUES('Maier', " \
      "'Hans', 6714, 3500, '15.03.1962')"
cursor.execute(sql)
connection.commit() # Änderungen an den Daten müssen wir bestätigen
